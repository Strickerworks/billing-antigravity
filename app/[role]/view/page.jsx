...
export default function ViewInvoice() {
  ...
  const handleFetch = async () => {
    ...
    if (error) {
      ...
      setErrorMsg("Invoice not found. Please check the number and try again.");
    } else {
      setFetchedData(data);
  ...
  const inWords = (num) => {
    ...
    if (num) str += (str !== "" ? "and " : "") + twoDigits(num) + " ";
  ...
  return (
    <div className="page-content">
      <div className="page-header">
        ...
        <p className="page-subtitle">Enter an invoice number to preview it as a PDF.</p>
      </div>
      ...
      <div className="card fade-in" style={{ maxWidth: 460, marginBottom: "1.5rem" }}>
        ...
        {errorMsg && (
          <p style={{ fontSize: "0.8rem", color: "#dc2626", marginTop: "0.6rem", marginBottom: 0 }}>
            {errorMsg}
          </p>
        )}
      </div>

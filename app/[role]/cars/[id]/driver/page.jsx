  ...
  return (
    <div className="page-content" style={{ maxWidth: 800, paddingBottom: "3rem" }}>
      ...
      <div className="card" style={{ padding: "1.5rem", background: "var(--bg-card)", border: "1px solid var(--border)", marginBottom: "2rem" }}>
        <h2 style={{ fontSize: "1.1rem", fontWeight: 700, marginBottom: "1rem", color: "var(--text-primary)" }}>Choose Driver</h2>
        <form onSubmit={handleSubmit} style={{ display: "flex", gap: "1.25rem", alignItems: "flex-end", flexWrap: "wrap" }}>
          ...
          <button
            ...
            style={{ height: "42px", fontSize: "0.85rem", padding: "0.6rem 2rem", background: "var(--text-primary)", color: "var(--bg-card)", borderColor: "var(--text-primary)" }}
          >
      ...
      <div className="card" style={{ padding: "1.5rem", background: "var(--bg-card)", border: "1px solid var(--border)" }}>
        ...
        {driverLogs.length === 0 ? (
          <p style={{ color: "var(--text-secondary)", fontSize: "0.85rem" }}>No driver assignments recorded.</p>
        ) : (

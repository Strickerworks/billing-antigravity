  ...
  return (
    <div className="page-content" style={{ maxWidth: 800, paddingBottom: "3rem" }}>
      ...
      <div className="card" style={{ padding: "1.5rem", background: "#ffffff", border: "1px solid #e5e7eb" }}>
        <h2 style={{ fontSize: "1.1rem", fontWeight: 700, marginBottom: "1.25rem", color: "#111827" }}>Misc Costs Log History</h2>
        {miscLogs.length === 0 ? (
          <p style={{ color: "#6b7280", fontSize: "0.85rem" }}>No misc costs recorded.</p>
        ) : (
